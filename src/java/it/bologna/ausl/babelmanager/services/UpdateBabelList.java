 ...
 * @author spritz
 */
public class UpdateBabelList extends HttpServlet {
...
//private static int IDATTIVITA_MAX_LENGTH = 20;
     ...
     */
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String action) throws ServletException, UnsupportedEncodingException, IOException {
...
//        BasicConfigurator.configure();
        ...
        try {
            JSONArray array = (JSONArray) JSONValue.parse(new InputStreamReader(request.getInputStream(), "UTF8"));
            if (array != null) {
                log.info("dimensione array attivita: " + array.size());
            } else {
                log.info("array null");
            }

            for (Iterator it = array.iterator(); it.hasNext();) {
                org.json.simple.JSONObject jsonObj = (org.json.simple.JSONObject) it.next();
            ...
            if (!allowedUser(auth, servUsername, servPassword)) {
                ...
                return;
                    ...
                    idapplicazione = (jsonObj.get("idapplicazione") == null) ? null : (String) jsonObj.get("idapplicazione");
                    tokenapplicazione = (jsonObj.get("tokenapplicazione") == null) ? null : (String) jsonObj.get("tokenapplicazione");

                    // dati per l'esecuzione della query
                    idattivita = (jsonObj.get("idattivita") == null) ? null : (String) jsonObj.get("idattivita");
                    idesterno = (jsonObj.get("idesterno") == null) ? null : (String) jsonObj.get("idesterno");
                    idutenti = (jsonObj.get("idutenti") == null) ? null : (String) jsonObj.get("idutenti");
                    idtipiattivita = (jsonObj.get("idtipiattivita") == null) ? null : (String) jsonObj.get("idtipiattivita");
                    descrizioneattivita = (jsonObj.get("descrizioneattivita") == null) ? null : (String) jsonObj.get("descrizioneattivita");
                    urlcommand = (jsonObj.get("urlcommand") == null) ? null : (String) jsonObj.get("urlcommand");
                    datain = (jsonObj.get("datain") == null) ? null : (String) jsonObj.get("datain");
                    statoattivita = (jsonObj.get("statoattivita") == null) ? null : (String) jsonObj.get("statoattivita");
                    noteattivita = (jsonObj.get("noteattivita") == null) ? null : (String) jsonObj.get("noteattivita");

                    // tipo di operazione da eseguire (possibili valori: "insert" o "delete")
                    actiontype = (jsonObj.get("actiontype") == null) ? null : (String) jsonObj.get("actiontype");

                    // nuovi
                    labelurlcommand = (jsonObj.get("labelurlcommand") == null) ? null : (String) jsonObj.get("labelurlcommand");
                    urlcommand2 = (jsonObj.get("urlcommand2") == null) ? null : (String) jsonObj.get("urlcommand2");
                    labelurlcommand2 = (jsonObj.get("labelurlcommand2") == null) ? null : (String) jsonObj.get("labelurlcommand2");
                    urlcommand3 = (jsonObj.get("urlcommand3") == null) ? null : (String) jsonObj.get("urlcommand3");
                    labelurlcommand3 = (jsonObj.get("labelurlcommand3") == null) ? null : (String) jsonObj.get("labelurlcommand3");
                    uuidanteprima = (jsonObj.get("uuidanteprima") == null) ? null : (String) jsonObj.get("uuidanteprima");
                    provenienza = (jsonObj.get("provenienza") == null) ? null : (String) jsonObj.get("provenienza");
                    oggettoattivita = (jsonObj.get("oggettoattivita") == null) ? null : (String) jsonObj.get("oggettoattivita");
                    priorita = (jsonObj.get("priorita") == null) ? null : (String) jsonObj.get("priorita");
                    datascadenza = (jsonObj.get("datascadenza") == null) ? null : (String) jsonObj.get("datascadenza");

                    customapp1 = (jsonObj.get("customapp1") == null) ? null : (String) jsonObj.get("customapp1");
                    customapp2 = (jsonObj.get("customapp2") == null) ? null : (String) jsonObj.get("customapp2");
                    customapp3 = (jsonObj.get("customapp3") == null) ? null : (String) jsonObj.get("customapp3");
                    customapp4 = (jsonObj.get("customapp4") == null) ? null : (String) jsonObj.get("customapp4");
                    customapp5 = (jsonObj.get("customapp5") == null) ? null : (String) jsonObj.get("customapp5");

                    permesso = (jsonObj.get("permesso") == null) ? null : (String) jsonObj.get("permesso");

                    idsorgente = (jsonObj.get("idsorgente") == null) ? null : (String) jsonObj.get("idsorgente");
                    tiposorgente = (jsonObj.get("tiposorgente") == null) ? null : (String) jsonObj.get("tiposorgente");
                    idriferimento = (jsonObj.get("idriferimento") == null) ? null : (String) jsonObj.get("idriferimento");
                    tiporiferimento = (jsonObj.get("tiporiferimento") == null) ? null : (String) jsonObj.get("tiporiferimento");
                    gruppo = (jsonObj.get("gruppo") == null) ? null : (String) jsonObj.get("gruppo");

                    updatestorico = (jsonObj.get("updatestorico") == null) ? null : (String) jsonObj.get("updatestorico");

                    setattivita = (jsonObj.get("setattivita") == null) ? null : (String) jsonObj.get("setattivita");
                    archiviazione = (jsonObj.get("archiviazione") == null) ? null : (String) jsonObj.get("archiviazione");
                    setaccessoesclusivo = (jsonObj.get("setaccessoesclusivo") == null) ? null : (String) jsonObj.get("setaccessoesclusivo");
